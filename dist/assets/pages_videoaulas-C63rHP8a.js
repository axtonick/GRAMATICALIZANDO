import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               *//* empty css             *//* empty css                   *//* empty css                */import"./app-X42WGwqI.js";import{i as r}from"./page-base-BVDhhXmt.js";import{p as d}from"./storage-CrKITpRL.js";r();const o=document.getElementById("videoLessonsList"),n=document.getElementById("videoLessonsCount"),l=(t="")=>{const e=String(t).trim();return e?/^https?:\/\//i.test(e)?e:`https://${e}`:"#"},p=t=>{if(!t)return"Data a definir";const e=new Date(t);return Number.isNaN(e.getTime())?"Data a definir":new Intl.DateTimeFormat("pt-BR",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"}).format(e)},c=()=>{if(!o)return;const t=d();if(!t.length){n.textContent="0",o.innerHTML=`
