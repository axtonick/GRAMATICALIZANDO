import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               *//* empty css                  */import{i as n}from"./base-bEGeGQbm.js";import{I as d,n as r,H as u}from"./storage-CrKITpRL.js";const c=n("simulados");if(!c)throw new Error("Acesso negado.");const a=document.getElementById("simuladoList"),s=(e="")=>String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),i=()=>{if(!a)return;const e=r();if(!e.length){a.innerHTML=`
