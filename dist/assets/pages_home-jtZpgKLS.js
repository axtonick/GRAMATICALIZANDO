import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               *//* empty css             */import"./app-C7RpvBac.js";import{i as l}from"./page-base-BVDhhXmt.js";import"./storage-GM3fP61i.js";l();const t=document.getElementById("homeLessons"),n=document.getElementById("homeExercises"),r=(a="")=>String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),i=(a,o,s)=>{a&&(a.innerHTML=`<div class="home-empty"><strong>${r(o)}</strong><p>${r(s)}</p></div>`)},p=({materias:a=[],aulas:o=[],exercicios:s=[]})=>{const c=new Map(a.map(e=>[e.id,e.nome]));t&&(o.length?t.innerHTML=o.slice(0,6).map(e=>`
