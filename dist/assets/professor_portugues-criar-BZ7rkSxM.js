      ...
      <div class="question-editor-layout">
        ...
        <div class="question-editor-side">
          <div class="question-upload-card">
            ...
            <small class="field-help">${d(b)}. Limite de 20 MB.</small>
          </div>
        </div>
      </div>
    `:"",D=`<input data-field="${C}" type="file" accept="${h}"><small class="field-help">${d(b)}. Limite de 20 MB.</small>${n&&i?`<img class="content-block-image block-image-preview" src="${d(i)}" alt="${d(t.nome||t.titulo||"Prévia da imagem")}">`:""}`,F=a?P:"";return`<article class="block-field-card" data-block-id="${d(t.id)}">
